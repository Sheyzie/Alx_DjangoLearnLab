...
from .views import register, UserProfileView, UserProfileUpdateView, PostCreateView, PostListView, PostDetailView, PostUpdateView, PostDeleteView, add_comment, CommentCreateView, CommentUpdateView, CommentDeleteView, PostByTagListView, SearchPostListView
